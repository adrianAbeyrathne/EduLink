  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.user && response.token) {
        ...
        // Navigate immediately after login instead of relying on useEffect
      ...
      if (error.response?.data?.message) {
        ...
        if (errorMessage.includes("This account is not registered as") || errorMessage.includes("Access denied. This account is not registered as")) {
