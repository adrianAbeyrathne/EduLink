  ...
  const handleSave = async () => {
    try {
      ...
      if (result.success) {
        ...
        window.location.reload(); // Temporary fix to ensure status updates are visible
      } else {
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className={`px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(user.userStatus || 'Available')}`}>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                {isEditing ? (
                  ...
                  <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(user.userStatus || 'Available')}`}>
                    {user.userStatus || 'Available'}
                  </span>
                )}
              </div>
